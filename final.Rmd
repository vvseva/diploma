...
```{r}
DS = c("probabilistic model*", "regression*", "machine learning", "data mining", "standard deviation", "ttest", "probanilit*", "logistic", "gini", "ks*", "loss", "chi-square*", "z-score*", "sensitivity analysis*", "factorial design", "process model", "microsimulation", "time series") %>% as_tibble()

Rules = c("decision rule*", "decision tree*", "decision process*",
          "simple rule*", "fuzzy", "working memory", "ifelse", "decision rule*", "behavior rule*", "set of rules", "dummy", "synthetic", "individual actor*", "dynamics model*", "emerg*")%>% as_tibble()

Networks = c("network*", "social network*", "network representation", "network science", "node*", "edge*",  "vertice", "random network", "preferential attachment", "small-world", "centrality", "barabasi", "watts", "odd", "scale free", "network structure", "degree destribution", "peer effect*", "ba network", "small world network", "network topology") %>% as_tibble()

Theory = c("bounded*", "bias*", "planned behav*", "satisficing", "desire*", "belief*" ,"social norm*", "risk aversion", "prospects", "prospect theory", "utilit*", "payoff*", "game theory", "reward*", "bdi", "hueristic*", "complex*", "cooperat*", "dilemma", "bounded rationalit*", "bounded confid*", "complex system*", "social system*", "social interaction*", "opinion dynamics", "conceptual model", "synthetic population", "opinion formation", "social impact", "multi-agent") %>% as_tibble()
...
```{r}
kwic(corpus_max, pattern = phrase("dependence degree")
...
title_word_pairs %>%
  ...
  geom_edge_link(alpha = 0.5, color = "cyan4") +
